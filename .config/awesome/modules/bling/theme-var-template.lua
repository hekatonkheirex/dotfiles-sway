...
theme.tabbar_bg_focus = "#cba6f7" -- background color of unfocused clients on the tabbar
theme.tabbar_fg_focus = "#1e1e2e" -- foreground color of unfocused clients on the tabbar
